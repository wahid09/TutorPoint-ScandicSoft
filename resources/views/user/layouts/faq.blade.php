...
<div class="test-faq">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 testimonial wow fadeInLeft float-right">
                <div class="wrapper">
                    <h3>TESTIMONIALS</h3>
            ...
            <!-- /.testimonial -->
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 faq wow fadeInRight float-left">
                <div class="wrapper">
