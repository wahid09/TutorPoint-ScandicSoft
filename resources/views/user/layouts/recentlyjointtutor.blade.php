...
<div class="popular-course wow fadeInUp theme-bg-color mFix">
    <div class="container">
        <h2>Recently joined Tutor</h2>
        <div class="row">
            <div class="theme-slider course-item-wrapper">
                <div class="item hvr-float-shadow">
                    <div class="img-holder"><img src="{{asset('user/images/home/2.jpg')}}" alt="Image"></div>
                    <div class="text">
                        <h4><a href="course-details.html">web development courses</a></h4>
                        <div class="img round-border"><img src="{{asset('user/images/home/1.png')}}" alt="Image"></div>
                        <h6>Mahfuz riad</h6>
                        <ul>
                        ...
                        <div class="clear-fix">
                            ...
                            <a href="#" class="tran3s p-color-bg themehover">Profile</a>
                        </div>
                    </div>
                    <!-- /.text -->
                </div>
                <!-- /.item -->
                <div class="item hvr-float-shadow">
                    <div class="img-holder"><img src="{{asset('user/images/home/3.jpg')}}" alt="Image"></div>
                    <div class="text">
                ...
                <!-- /.item -->
                <div class="item hvr-float-shadow">
                    <div class="img-holder"><img src="{{asset('user/images/home/4.jpg')}}" alt="Image"></div>
                    <div class="text">
