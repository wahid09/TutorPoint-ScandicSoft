<!-- Footer ______________________________ -->
        <footer>
            ...
            <div class="bottom-footer">
                <p>Copyright 2016 &copy; <a href="" class="tran3s" target="_blank">TutorPoint</a> <span>|</span> Designed by <span class="p-color">SoftScandic</span></p>
            </div>
            <!-- /.bottom-footer -->
        </footer>
        <!-- Scroll Top Button -->
        ...
        <!-- j Query -->
        <script type="text/javascript" src="{{ asset('user/vendor/jquery-2.1.4.js') }}"></script>
        <!-- Bootstrap JS -->
        <script type="text/javascript" src="{{ asset('user/vendor/bootstrap/bootstrap.min.js') }}"></script>
        <!-- Vendor js _________ -->
        <!-- revolution -->
        <script src="{{ asset('user/vendor/revolution/jquery.themepunch.tools.min.js') }}"></script>
        <script src="{{ asset('user/vendor/revolution/jquery.themepunch.revolution.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('user/vendor/revolution/revolution.extension.slideanims.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('vendor/revolution/revolution.extension.layeranimation.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('user/vendor/revolution/revolution.extension.navigation.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('user/vendor/revolution/revolution.extension.kenburn.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('user/vendor/revolution/revolution.extension.actions.min.js') }}"></script>
        <!-- Google map js -->
        <script src="http://maps.google.com/maps/api/js"></script>
        <!-- Gmap Helper -->
        <script src="{{ asset('user/vendor/gmap.js') }}"></script>
        <!-- Bootstrap Select JS -->
        <script type="text/javascript" src="{{ asset('user/vendor/bootstrap-select/dist/js/bootstrap-select.js') }}"></script>
        <!-- Time picker -->
        <script type="text/javascript" src="{{ asset('user/vendor/time-picker/jquery.timepicker.min.js') }}"></script>
        <!-- WOW js -->
        <script type="text/javascript" src="{{ asset('user/vendor/WOW-master/dist/wow.min.js') }}"></script>
        <!-- owl.carousel -->
        <script type="text/javascript" src="{{ asset('user/vendor/owl-carousel/owl.carousel.min.js') }}"></script>
        <!-- js count to -->
        <script type="text/javascript" src="{{ asset('user/vendor/jquery.appear.js') }}"></script>
