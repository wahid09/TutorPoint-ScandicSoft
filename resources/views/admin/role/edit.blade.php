                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-horizontal" action="{{route('role.update', $role->id)}}" method="POST">
                            {{csrf_field()}}
                            {{method_field('PUT')}}                                <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="email_address_2" name="name" class="form-control" placeholder="Enter your Area" value="{{$role->name}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-6 col-xs-7">
                                    <div class="form-group">
                                        ...
                                        <div class="demo-checkbox">
                                            ...
                                            <input type="checkbox" class="filled-in chk-col-blue"/ value="{{$permission->id}}"
