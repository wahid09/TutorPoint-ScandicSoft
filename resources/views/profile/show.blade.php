                        ...
                        <div class="col-md-8">
                            <div class="user-profile">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            <img src="{{asset('user/images/user/user.png')}}" class="user-big-img" alt="user image">
                        ...
                        <div class="col-md-4 faq-request">
                            <div class="faq-body">
                                <div class="list-group">
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action"><i class="fa fa-camera"></i>&nbsp;My Photo</a>
